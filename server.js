...
Здравствуйте, ${userName}! Спасибо что выбрали клуб Много.ру! :)

Это наша новая игра МногоБукв, в которой можно получать призы 🎁 😍

Играйте каждый день, копите бонусы и обменивайте их на призы из нашего каталога 👇
        ...
        reply_markup: {
            inline_keyboard: [
                ...
                [
                    ...
                    {text: ‘💰 Бонусный ‘счет, callback_data: 'balance'}
                ],
                [
                    {text: '🆘 Поддержка', callback_data: 'support'}
                ],
                [
                    {text: ‘🆕 Регистрация, callback_data: 'support'}
                ],
                [
                    {text: ‘🛍️ Магащин призов, callback_data: 'support'}
                ]
            ]
        }
    });
...
Для просмотра актуального бонусного счёта:
1️⃣ Откройте игру
2️⃣ Авторизуйтесь по номеру карты  
3️⃣ Баланс отобразится в приложении

🎯 Играйте каждый день и зарабатывайте бонусы!`, {
                parse_mode: 'Markdown',
                reply_markup: {
                    inline_keyboard: [[
...
• Не начисляются бонусы? Свяжитесь с службой поддержки 
...
function sendHelpMessage(chatId) {
    bot.sendMessage(chatId, `©️ **ПРАВИЛА ИГРЫ**
...
🏆 **Победа:** +50 бонусов  
🎯 **Участие:** +10 бонусов
💎 **Тратьте бонусы на призы в нашем клубе!**
